...
export default function CreateAssessment() {
  ...
  async function deleteAssessment(id) {
    ...
    try {
      await api.delete(`/assessments/${id}/delete/`)
      ...
      <main style={{
        ...
        <form onSubmit={submit}>
          ...
          <section style={sec}>
            <h3 style={secTitle}>
              Select Questions
              ({form.question_ids.length} selected)
            </h3>
              ...
              {questions.map(q => (
                <label
                  ...
                  style={{
                    ...
                    gap:10,
                    padding:'10px',
                    background: form.question_ids.includes(q.id)
                      ? '#f0f0ff'
                      : '#f9f9f9',
                    borderRadius:8,
                    border:`1.5px solid ${
