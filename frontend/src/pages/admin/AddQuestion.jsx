  ...
  return (
    <div style={{ minHeight:'100vh', background:'#f5f5f5' }}>
      ...
      <main style={{ maxWidth:680, margin:'2rem auto', padding:'0 1rem' }}>
        ...
        {success && (
          <div style={{ background:'#d4edda', color:'#155724', padding:'10px 16px', borderRadius:8, marginBottom:16 }}>
            ✓ Question saved!
          </div>
        )}
          ...
          <div style={{ marginBottom:16 }}>
            ...
            {choices.map((c,i) => (
              ...
              >
                ...
                <span style={{ fontWeight:700, color:'#667eea', width:20 }}>
                  {c.label}.
                </span>
